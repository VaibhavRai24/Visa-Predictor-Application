...
class ModelEvaluation:
    ...
    def get_best_model(self) ->Optional[USvisaModel]:
        ...
        try:
            ...
            us_visa_estimator = USvisaEstimator(bucket_name= bucket_name, model_path= model_path)
            if us_visa_estimator.is_model_present(model_path= model_path):
                return us_visa_estimator
            return None
        except Exception as e:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            result=  EvaluateModelResponse(trained_model_f1_score= trained_model_f1_score,
                                           best_model_f1_score= best_model_f1_score, is_model_accepted= trained_model_f1_score > tmp_best_model_score,
                                           diffrence= trained_model_f1_score - tmp_best_model_score)
    ...
    def initiate_model_evaluation(self) ->ModelEvaluationArtifact:
        ...
        try:
            ...
            model_evaluation_artifact = ModelEvaluationArtifact(
                ...
                changed_accuracy= evaluate_model_response.diffrence
            )
