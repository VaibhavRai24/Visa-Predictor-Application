...
class DataTransformation:
    ...
    def get_data_transformer_object(self) ->Pipeline:
        ...
        try:
            ...
            logging.info("Initiated StandardSclaer , OneHotEncoder, OrdinalEnoder")
            oh_columns = self._schema_config['oh_columns']
            or_columns = self._schema_config["or_columns"]
            transfor_columns = self._schema_config["transform_columns"]
            num_features = self._schema_config["num_features"]
            
            
            logging.info("Initiated Power Transformers")
            ...
            logging.info("Created preprocessor object for ColumnTransformation")
            return preprocessor
    ...
    def intiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                logging.info("Added company age column to the training dataset")
                ...
                logging.info("Applying SMOTEENN on Training and Testing dataset")
