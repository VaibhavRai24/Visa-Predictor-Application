...
class DataTransformationConfig:
    ...
    transformed_trained_file_path:str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,TRAIN_FILE_NAME.replace("csv", "npy"))
...
class ModelTrainerConfig:
    ...
    excpected_accuracy: float = MODEL_TRAINER_EXPECTED_SCORE
