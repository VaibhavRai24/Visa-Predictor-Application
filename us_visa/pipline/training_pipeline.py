...
from us_visa.entity.artifact_entity import ModelTrainerArtifact, ClassificationArtifact
...
class TrainPipeline:
    ...
    def start_model_evaluation(self, data_ingestion_artifact: DataIngestionArtifact, model_trainer_artifact: ModelTrainerArtifact) ->ModelEvaluationArtifact:
        ...
        try:
            ...
            model_evaliation_artifact = model_evaluation.initiate_model_evaluation()
            return model_evaliation_artifact
        except Exception as e:
            raise MyException(e, sys)
